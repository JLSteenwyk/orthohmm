...
class TestLongNames(object):
    def test_simple_case(self):
        ...
        """
        kwargs = dict(
            fasta_directory=f"{here.parent.parent}/samples/long_names/",
            output_directory=f"{here.parent.parent}/samples/long_names/",
            phmmer="phmmer",
            cpu=8,
        ...
        with open(f"{here.parent.parent}/expected/long_names/orthohmm_gene_count.txt", "r") as expected:
            lines = expected.readlines()[:20]    # Only take the first 20 lines
            expected_orthohmm_gene_count = "".join(lines)

        with open(f"{here.parent.parent}/samples/long_names/orthohmm_gene_count.txt", "r") as out_file:
            lines = out_file.readlines()[:20]    # Only take the first 20 lines
            output_orthohmm_gene_count = "".join(lines)

        # read orthogroups
        with open(f"{here.parent.parent}/expected/long_names/orthohmm_orthogroups.txt", "r") as expected:
            lines = expected.readlines()[:20]    # Only take the first 20 lines
            expected_orthohmm_orthogroups = "".join(lines)

        with open(f"{here.parent.parent}/samples/long_names/orthohmm_orthogroups.txt", "r") as out_file:
            lines = out_file.readlines()[:20]    # Only take the first 20 lines
            output_orthohmm_orthogroups = "".join(lines)

        # read single-copy orthogroups
        with open(f"{here.parent.parent}/expected/long_names/orthohmm_single_copy_orthogroups.txt", "r") as expected:
            lines = expected.readlines()[:5]    # Only take the first 5 lines
            expected_orthohmm_single_copy_orthogroups = "".join(lines)

        with open(f"{here.parent.parent}/samples/long_names/orthohmm_single_copy_orthogroups.txt", "r") as out_file:
            lines = out_file.readlines()[:5]    # Only take the first 5 lines
            output_orthohmm_single_copy_orthogroups = "".join(lines)

        # determine how many files were made in single-copy and all orthogroup directories
        files_orthohmm_single_copy_orthogroups = [
            f for f in os.listdir(f"{here.parent.parent}/samples/long_names/orthohmm_single_copy_orthogroups/") if os.path.isfile(os.path.join(f"{here.parent.parent}/samples/long_names/orthohmm_single_copy_orthogroups/", f))
        ]

        files_orthohmm_orthogroups = [
            f for f in os.listdir(f"{here.parent.parent}/samples/long_names/orthohmm_orthogroups/") if os.path.isfile(os.path.join(f"{here.parent.parent}/samples/long_names/orthohmm_orthogroups/", f))
        ]

        # read some individual ortholog fasta files
        with open(f"{here.parent.parent}/expected/long_names/orthohmm_orthogroups/OG0.fa", "r") as expected:
            expected_OG0 = expected.read()

        with open(f"{here.parent.parent}/samples/long_names/orthohmm_orthogroups/OG0.fa", "r") as out_file:
            output_OG0 = out_file.read()

        with open(f"{here.parent.parent}/expected/long_names/orthohmm_orthogroups/OG1.fa", "r") as expected:
            expected_OG1 = expected.read()

        with open(f"{here.parent.parent}/samples/long_names/orthohmm_orthogroups/OG1.fa", "r") as out_file:
            output_OG1 = out_file.read()

        with open(f"{here.parent.parent}/expected/long_names/orthohmm_orthogroups/OG2.fa", "r") as expected:
            expected_OG2 = expected.read()

        with open(f"{here.parent.parent}/samples/long_names/orthohmm_orthogroups/OG2.fa", "r") as out_file:
            output_OG2 = out_file.read()

        with open(f"{here.parent.parent}/expected/long_names/orthohmm_orthogroups/OG3.fa", "r") as expected:
            expected_OG3 = expected.read()

        with open(f"{here.parent.parent}/samples/long_names/orthohmm_orthogroups/OG3.fa", "r") as out_file:
            output_OG3 = out_file.read()

        with open(f"{here.parent.parent}/expected/long_names/orthohmm_orthogroups/OG4.fa", "r") as expected:
            expected_OG4 = expected.read()

        with open(f"{here.parent.parent}/samples/long_names/orthohmm_orthogroups/OG4.fa", "r") as out_file:
            output_OG4 = out_file.read()

        with open(f"{here.parent.parent}/expected/long_names/orthohmm_single_copy_orthogroups/OG8.fa", "r") as expected:
            expected_OG2_sc = expected.read()

        with open(f"{here.parent.parent}/samples/long_names/orthohmm_single_copy_orthogroups/OG8.fa", "r") as out_file:
        ...
        assert os.path.isdir(f"{here.parent.parent}/samples/long_names/orthohmm_single_copy_orthogroups/")
        assert os.path.isdir(f"{here.parent.parent}/samples/long_names/orthohmm_orthogroups/")

        assert len(files_orthohmm_single_copy_orthogroups) == 9
        assert len(files_orthohmm_orthogroups) == 988
    ...
    # def test_simple_case_check_orthohmm_gene_count_only(self):
    #     """
    #     test simple case
    #     usage: orthohmm ./path_to_fasta_directory
    #     """
    ...
    # def test_simple_case_orthohmm_orthogroups_only(self):
    #     """
    #     test simple case
    #     usage: orthohmm ./path_to_fasta_directory
    #     """
    ...
    # def test_simple_case_orthohmm_single_copy_orthogroup_only(self):
    #     """
    #     test simple case
    #     usage: orthohmm ./path_to_fasta_directory
    #     """
    ...
    # def test_simple_case_check_number_of_files_made_in_sc_and_all_ogs_dirs_only(self):
    #     """
    #     test simple case
    #     usage: orthohmm ./path_to_fasta_directory
    #     """
    ...
    # def test_simple_case_check_individual_og_files_only(self):
    #     """
    #     test simple case
    #     usage: orthohmm ./path_to_fasta_directory
    #     """
    ...
    # def test_simple_case_check_individual_scog_files_only(self):
    #     """
    #     test simple case
    #     usage: orthohmm ./path_to_fasta_directory
    #     """

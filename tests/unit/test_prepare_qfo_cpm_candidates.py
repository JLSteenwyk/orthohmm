...
def test_replay_evidence(tmp_path, monkeypatch, problem):
    executor = tmp_path / "benchmarks/work/publication_qfo_cpm_variant_admission_v3"
    ...
    path = tmp_path / "benchmarks/work/qfo_cpm_variant_admission_22082_0.json"
    ...
    def check_output(command, **kwargs):
        if command[0] == "sacct":
            ...
            assert command[1:3] == ["-j", "22082"]
            return f"JobID|JobIDRaw|State|ExitCode|Elapsed|NodeList|AllocCPUS\n22082_0|22083|COMPLETED|0:0|00:01:00|bizon|{cpus}\n"

#!/bin/bash
#SBATCH --job-name=qfo_blast_native_representation_admit
...
#SBATCH --no-requeue
#SBATCH --output=/mnt/ca1e2e99-718e-417c-9ba6-62421455971a/ORTHOHMM/orthohmm/benchmarks/work/qfo_blast_native_representation_admit_%j.log
set -euo pipefail
...
exec /home/bizon/anaconda3/bin/python -B -m benchmark_tools.admit_blast_recovery_search \
  --root "$ROOT" --replacement --reviewed-native-o \
  --output "$ROOT/benchmarks/results/qfo_blast_native_representation_admission_v1"

...
| --- | ---: | ---: | ---: | ---: |
| OrthoFinder 3.1.5 full phylogenetic pipeline | **0.7821** | 0.7270 | 0.9886 | 3/3 |
| SonicParanoid 2.0.9 | 0.7589 | 0.4680 | **0.9908** | 3/3 |
| ProteinOrtho 6.3.6 | 0.7531 | 0.4510 | 0.9305 | 3/3 |
...
F1 is SonicParanoid at **0.9908**. OrthoMCL QfO inference job `20909` is
running, with official QfO scoring job `20910` queued after it.

The corrected Three Kingdoms full-pipeline score restores OrthoFinder-sanitized
accessions from the staged FASTA headers before evaluation. Sequence-only leads
the full root-HOG output by just 0.0009 on this benchmark.

SonicParanoid and ProteinOrtho QfO values use their native pairwise relation
outputs. Their earlier group-clique means, 0.5601 and 0.7511 respectively,
are retracted because they did not represent the tools' native pair calls.

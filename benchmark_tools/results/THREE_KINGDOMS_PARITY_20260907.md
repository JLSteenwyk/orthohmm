...
|---|---|---:|---:|---:|---:|---:|---:|---:|
| SonicParanoid 2.0.9 | default mode; DIAMOND very-sensitive | 0.9934 | 0.9882 | 0.9908 | 99.8% | 19,853 | 1:14:39 | 7.90 GiB |
...
OrthoHMM phylogeny improves F-score by +0.0458 over high sensitivity alone and is -0.1164 versus OrthoFinder's full root-HOG output.
...
OrthoMCL is 0.0005 below OrthoFinder's sequence-only checkpoint, but its legacy BLAST stage makes it much slower on this dataset.

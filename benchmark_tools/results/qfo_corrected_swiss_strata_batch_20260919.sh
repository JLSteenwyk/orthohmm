#!/bin/bash
#SBATCH --job-name=qfo_corrected_swiss_strata
...
#SBATCH --no-requeue
#SBATCH --output=/mnt/ca1e2e99-718e-417c-9ba6-62421455971a/ORTHOHMM/orthohmm/benchmarks/work/qfo_corrected_swiss_strata_%j.log
set -euo pipefail
...
OUTPUT="$ROOT/benchmarks/work/qfo_corrected_swiss_primary_strata_v1.json"
[[ ! -e "$OUTPUT" && ! -L "$OUTPUT" ]]

...
cd "$ROOT"
exec /home/bizon/anaconda3/bin/python "$EXECUTOR/benchmark_tools/admit_qfo_corrected_fastoma.py" \
    --root "$ROOT" --job "$INFERENCE_JOB" --stage-job "$STAGE_JOB" \
    --output "$ROOT/benchmarks/work/qfo_corrected_fastoma_admission_20260918.json"

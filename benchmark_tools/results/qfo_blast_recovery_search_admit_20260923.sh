#!/bin/bash
#SBATCH --job-name=qfo_blast_recovery_search_admit
#SBATCH --nodelist=bizon
#SBATCH --cpus-per-task=2
#SBATCH --mem=64G
#SBATCH --time=24:00:00
#SBATCH --dependency=afterok:22150
#SBATCH --no-requeue
#SBATCH --output=/mnt/ca1e2e99-718e-417c-9ba6-62421455971a/ORTHOHMM/orthohmm/benchmarks/work/qfo_blast_recovery_search_admit_%j.log
set -euo pipefail
...
exec /home/bizon/anaconda3/bin/python -B -m benchmark_tools.admit_blast_recovery_search \
  --root "$ROOT" --output "$ROOT/benchmarks/results/qfo_blast_recovery_search_admission_v1"

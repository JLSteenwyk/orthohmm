...
| Corrected QfO accuracy or rankings are established | [Admitted partial table](qfo_corrected_comparison_20260919_v5/scores.md), [complete factorial](QFO_CORRECTED_FACTORIAL_COMPLETE_20260919.md), [frozen rerun protocol](QFO_CORRECTED_RELEASE_PROTOCOL_20260917.md) | Six point-estimate rows are admitted: high-sensitivity and phylogenetic OrthoHMM, full and sequence-only OrthoFinder, Proteinortho and SonicParanoid. Full OrthoFinder exceeds phylogenetic OrthoHMM on all three F1 endpoints; OrthoHMM exceeds it on GO/EC similarity and FAS. All eight OrthoHMM factorial cells and conditional SwissTrees intervals are complete. FastOMA/OrthoMCL and comparator paired differences remain incomplete. No general superiority or complete ranking is established; no historical predictions or intervals may be relabeled |

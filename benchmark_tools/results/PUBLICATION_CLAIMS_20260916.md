...
| Corrected QfO accuracy or rankings are established | [Admitted partial table](qfo_corrected_comparison_20260919_v5/scores.md), [comparator intervals](CORRECTED_SWISS_COMPARISON_RESULT_21987.md), [complete factorial](QFO_CORRECTED_FACTORIAL_COMPLETE_20260919.md) | Six point-estimate rows and six conditional SwissTrees contrasts are admitted; FastOMA/OrthoMCL remain unavailable. Full OrthoFinder has higher point estimates than phylogenetic OrthoHMM on all three F1 endpoints; OrthoHMM has higher GO/EC similarity and FAS. Corrected phylogenetic-minus-sensitive SwissTrees F1 is +0.148015 with adjusted interval [0.049791, 0.266015], but phylogenetic-minus-OrthoFinder intervals include zero. All eight factorial cells are separately complete. No general superiority, equivalence or complete ranking; historical results cannot be relabeled |

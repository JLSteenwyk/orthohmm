...
| Corrected QfO accuracy or rankings are established | [Admitted partial table](qfo_corrected_comparison_20260919_v4/scores.md), [complete factorial](QFO_CORRECTED_FACTORIAL_COMPLETE_20260919.md), [frozen rerun protocol](QFO_CORRECTED_RELEASE_PROTOCOL_20260917.md) | High-sensitivity and phylogenetic OrthoHMM, Proteinortho and SonicParanoid point estimates are admitted; all eight OrthoHMM factorial cells and conditional SwissTrees intervals are complete. The eight-method comparison and comparator paired differences remain incomplete. No historical predictions or intervals may be relabeled |

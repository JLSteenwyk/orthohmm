...
| New counter controls establish controlled comparative timing | [Earlier interval integration](DGX_INTERVAL_NATIVE_RESULT_20260918.md), [quiet hierarchy result](DGX_HIERARCHY_QUIET_RESULT_20260918.md), [native frontier result](DGX_FRONTIER_NATIVE_RESULT_20260918.md), [prospective overhead panel](DGX_FRONTIER_OVERHEAD_SUBMISSION_21838.md) | Not established: frontier array21831 retains high-sensitivity interval1 and satellite intervals1,3 flags; OrthoFinder has none in that array. All earlier flags remain retained. Outside-target frontier counters do not explain the residuals or prove isolation. Overhead array21838 is still running; non-CPU isolation and scientific inclusion rules remain unresolved. No historical timing is upgraded |
...
| 3. HMM and phylogeny contributions | Completed OrthoBench and original-release QfO eight-cell factorials; paired SwissTrees simple effects/interactions; corrected-QfO four R-off scores and paired sequence controls; unconstrained-membership controls | Complete corrected-release QfO factorial; better-matched search sensitivity/calibration; controlled resource evidence. Corrected native/replay partition equality is admitted; older historical-input discrepancy remains and scores cannot be transferred |
...
| 7. Publication package | Sixteen bundled figure panels including descriptive DGX resources, plus newer corrected search-coverage and sequence-control figures; [method diagram](figures_publication_method_20260916/publication_method.pdf); evolving [manuscript](PUBLICATION_MANUSCRIPT_DRAFT_20260916.md); [relocated direct-evidence bundle](PUBLICATION_FIGURE_BUNDLE_20260918.md); bounded statistical reproduction; [current-source unit and CLI checks](PUBLICATION_TEST_REFRESH_20260918.md) | Completed corrected-QfO results and manuscript integration, refreshed figure bundle, verified bibliography, portable executable workflows/dependencies, transitive raw-data provenance and rights clearance, versioned release and external archive. The local figure bundle and statistical exports are not full scientific reproduction |

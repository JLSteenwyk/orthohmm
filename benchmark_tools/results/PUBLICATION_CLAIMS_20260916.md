...
| ARM and x86 scoring are generally equivalent | [Portability diagnostic](native_scoring_portability_20260917.json) | Not established: narrow-band discrepancies retained; default64 matches only the tested405synthetic pairs; full pipeline validation pending |

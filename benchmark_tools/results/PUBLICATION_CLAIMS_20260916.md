...
| 6. Biological usefulness | [Prospective WGD application protocol](BIOLOGICAL_WGD_APPLICATION_PROTOCOL_20260917.md) and [complete experimental cohort](biological_wgd_cohort_20260917.json); no application outcomes evaluated | Input/reference/chronology audit, fixed-method native runs, supported paralog-separation and coverage/contamination endpoints, all exclusions and prespecified examples; copy-specific orthology truth is not supplied by YGOB column order |

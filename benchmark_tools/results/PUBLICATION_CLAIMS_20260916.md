...
| ARM and x86 scoring are generally equivalent | [Portability diagnostic](native_scoring_portability_20260917.json), [isolated banding rescue](narrow_band_rescue_20260917.json), [one pipeline fixture](dgx_orthohmm_pipeline_smoke_20260917.json) | Not established: frozen narrow-band discrepancies remain; isolated per-pair patch rescues tested mismatches without changing baseline; default64 matches405synthetic pairs and both OH modes match one simulation fixture only |

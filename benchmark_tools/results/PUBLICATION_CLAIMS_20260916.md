...
| New counter controls establish controlled comparative timing | [Native smokes](DGX_COUNTER_NATIVE_SMOKE_RESULT_20260918.md), [bracketed controls](DGX_BRACKETED_CONTROLS_RESULT_20260918.md), [interval controls](DGX_INTERVAL_CONTROLS_RESULT_20260918.md) | Not established: short controls verify burst detection missed by whole-window averaging, but complete native-command integration, accounting/overhead treatment and scientific inclusion rules remain incomplete. No historical timing is upgraded |

...
| Original-release OrthoMCL final-group QfO scoring is complete | [Verified result snapshot](publication_comparison_orthomcl_complete_20260916.json), [corrected native admission](qfo_recovered_native_admission_22171.json), [corrected pair conversion](qfo_recovered_pairs_22172.json) | Supported for original inputs only. Corrected recovered search, native groups and conversion are now validated: 79,862 groups, 781,432 grouped proteins, 14,378,089 cross-species pairs. Corrected assessment 22174 is running and independent score admission 22176 is pending; no corrected score is yet admitted |
...
| --- | --- | --- |
| 1. Frozen publication baseline | [Corrected-QfO table with seven admitted rows](qfo_corrected_comparison_20260923_v6/scores.md), scoring corrections and prospective method pin; recovered OrthoMCL search/BPO/native groups and [pair conversion](qfo_recovered_pairs_22172.json) validated in production; corrected failed-query membership and reference exposure verified | Corrected OrthoMCL score admission remains pending on assessment 22174 and validator 22176. Require admitted scores, eight-method consolidation/uncertainty and raw-output provenance for every retained row. Direct failure exposure is not a counterfactual accuracy-effect bound; exact commands/versions/resources remain part of the baseline |

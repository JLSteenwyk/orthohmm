...
| 3. HMM and phylogeny contributions | Completed OrthoBench and original-release QfO eight-cell factorials; paired SwissTrees simple effects/interactions; corrected-QfO four R-off scores, [first R-on score](QFO_CORRECTED_FIRST_RECONCILIATION_SCORES_20260918.md) and paired sequence controls; unconstrained-membership controls | Complete corrected-release QfO factorial; better-matched search sensitivity/calibration; controlled resource evidence. First corrected R-on contrast raises precision and reduces recall; significance and interactions remain unestablished. Corrected native/replay partition equality is admitted; older historical-input discrepancy remains and scores cannot be transferred |
...
- Corrected Proteinortho has independently admitted six-endpoint scores and
  ...
  [seven-cell score export](qfo_corrected_factorial_scores_20260919_v4/scores.md)
  admits all four R-off cells, p0_c0_r1, p0_c1_r1 and p1_c0_r1, not the full eight-cell factorial.
  ...
  Complete-factorial paired uncertainty21894awaits final admission21788;

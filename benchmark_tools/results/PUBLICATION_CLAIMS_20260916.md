...
| 6. Biological usefulness | [Prospective WGD protocol](BIOLOGICAL_WGD_APPLICATION_PROTOCOL_20260917.md), admitted native runs and [complete cohort results with paired intervals](BIOLOGICAL_WGD_RESULTS_20260917.md): phylogeny improves supported separation over high sensitivity but trails full OrthoFinder and SonicParanoid in supported separation and homolog coverage | Independent membership rescore, prospective case inspection and figures; development-exposed application, not independent validation or copy-specific orthology truth; YGOB column order does not identify ancestral copies |

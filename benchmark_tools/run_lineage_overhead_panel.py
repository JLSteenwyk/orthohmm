"""Launch one pinned task of the complete lineage-collector overhead experiment."""
...
from benchmark_tools.measure_native_lineage_step import measure as periodic
from benchmark_tools.measure_lineage_boundary_step import measure as boundary
from benchmark_tools.probe_dgx_step_separation import save

PLAN_SHA = "90bcdb4b12655270dad2d69a3806174a4c4a63efb6e400b530e671b99938b1ed"
PROTOCOL_SHA = "6107283f87892c801408a1717eaba42d3dc104650b4603875281d3d08ac35893"
...
def select(plan_path, recipe_path, recipe_sha, auth_path, auth_sha, index):
    ...
    protocol = base / "results/LINEAGE_COLLECTOR_OVERHEAD_PROTOCOL_20260919.md"
    ...
    for path in [*base.glob("*.py"), base / "run_dgx_lineage_overhead.sh", protocol, plan_path.resolve()]:
...
def launch(plan_path, recipe_path, recipe_sha, auth_path, auth_sha, index):
    ...
    collector = periodic if task["mode"] == "periodic" else boundary

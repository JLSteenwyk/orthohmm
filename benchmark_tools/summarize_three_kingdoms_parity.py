...
METHODS = (
    ...
    MethodSpec(
        ...
        "OrthoMCL",
        "1.4",
        "defaults; legacy BLASTP; exact-compatible BPO conversion; MCL inflation 1.5",
...
def render_markdown(report: dict[str, Any]) -> str:
    ...
    lines.extend(
        [
            ...
            "- OrthoMCL used its native legacy BLAST and downstream inference. Its serial BioPerl BLAST-to-BPO conversion was replaced by a byte-compatible streaming converter validated against 6,417,790 native records; its wall time is the measured sum of those stages.",

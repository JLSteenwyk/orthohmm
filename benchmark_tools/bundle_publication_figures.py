...
if __name__ == "__main__":
    ...
    builder.add_argument("--audit", default=AUDIT, help="Committed repository-relative figure audit")
    verifier = commands.add_parser("verify")
    verifier.add_argument("directory", type=Path)
    args = parser.parse_args()
    result = build(args.repo, args.revision, args.output, args.audit) if args.command == "build" else verify(args.directory)

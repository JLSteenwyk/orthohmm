...
def main(argv=None) -> int:
    ...
    output_candidates = [
        ...
        output_directory / "orthohmm_working_res" / "phylogeny_candidate_superfamilies.txt",
        output_directory / "orthohmm_working_res" / "phylogeny_candidate_seeds.tsv",
        output_directory / "orthohmm_working_res" / "phylogeny_candidate_merges.json",
